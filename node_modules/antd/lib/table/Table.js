...
function (_React$Component) {
  ...
  function Table(props) {
    ...
    _this.generatePopupContainerFunc = function (getPopupContainer) {
      ...
      var table = _this.rcTable.current;
      ...
      if (scroll && scroll.scrollToFirstRowOnChange !== false) {
        (0, _scrollTo["default"])(0, {
          getContainer: function getContainer() {
            return _this.rcTable.current.bodyTable;
          }
        });
      }
    };
...
function withStore(WrappedComponent) {
  ...
  Component.Column = _Column["default"];
  Component.ColumnGroup = _ColumnGroup["default"];
  return Component;
}

(0, _reactLifecyclesCompat.polyfill)(Table);

var _default = withStore(Table);
